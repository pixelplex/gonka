...
func TestBridge_NotificationsDispatchToHandlers(t *testing.T) {
	...
	var gotEscrow shardbridge.EscrowInfo
	b.OnEscrowCreatedHandler(func(e shardbridge.EscrowInfo) error {
		gotEscrow = e
		return nil
	})
	...
	require.NoError(t, b.OnEscrowCreated(shardbridge.EscrowInfo{EscrowID: "42"}))
